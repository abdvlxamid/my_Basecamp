...
class DropsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drop" do
    assert_difference("Drop.count") do
      post drops_url, params: { drop: { description: @drop.description, project_id: @drop.project_id, title: @drop.title } }
    end
  ...
  test "should update drop" do
    patch drop_url(@drop), params: { drop: { description: @drop.description, project_id: @drop.project_id, title: @drop.title } }
