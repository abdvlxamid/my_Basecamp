...
class InboxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inbox" do
    assert_difference("Inbox.count") do
      post inboxes_url, params: { inbox: { name: @inbox.name, project_id: @inbox.project_id } }
    end
  ...
  test "should update inbox" do
    patch inbox_url(@inbox), params: { inbox: { name: @inbox.name, project_id: @inbox.project_id } }
